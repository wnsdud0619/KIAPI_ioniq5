...
def launch_setup(context, *args, **kwargs):
    ...
    # set passthrough filter as a component
    ...
    passthrough_component = ComposableNode(
            ...
            parameters=[{
                # use an effectively infinite pass‐through on the 'x' axis
                "filter_field_name": "x",
                "min_value": -1e6,
                "max_value": 1e6,
            }],
...
def generate_launch_description():
    ...
    sample_sensor_kit_launch_share_dir = get_package_share_directory("kiapi_sensor_kit_launch")

    add_launch_arg("frame_id", "base_link")
